...
interface ActivityResultHandler {
   ...
   * @param resultCode
   * @param data
   * @return Whether it was handled or not. If the implementation of this method decides it will not
   * handle it (eg: wrong requestCode), return false. Otherwise, return true
   */
